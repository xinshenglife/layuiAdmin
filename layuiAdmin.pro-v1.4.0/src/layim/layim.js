...
layui
  .define(["layer", "laytpl", "upload"], function (O) {
    function a() {
      (this.v = t),
      ...
      return (
        ...
        [
          ...
          '<li layim-event="chat" data-type="' +
            ...
            (a.index || "i") +
            ' }}" class="layim-' +
            ("history" === a.type ? "{{=i}}" : a.type + "{{=data.id}}") +
            ' {{= data.status === "offline" ? "layim-list-gray" : "" }}"><img src="{{= data.avatar || layui.layim.cache().base.defaultAvatar }}"><span>{{= data.username||data.groupname||data.name||"\u4f5a\u540d" }}</span><p>{{= data.remark||data.sign||"" }}</p><span class="layim-msg-status">new</span></li>',
          "{{# }); if(length === 0){ }}",
          '<li class="layim-null">' +
            ({
              friend: "\u8be5\u5206\u7ec4\u4e0b\u6682\u65e0\u597d\u53cb",
    ...
    function c(a, i, e) {
      m.ajax({
        ...
        success: function (a) {
          0 == a.code
            ? i && i(a.data || {})
            : f.msg(a.msg || (e || "Error") + ": LAYIM_NOT_GET_DATA", {
                time: 5e3,
              });
        },
        error: function (a, i) {
          window.console &&
            console.log &&
            console.error("LAYIM_DATE_ERROR\uff1a" + i);
        },
      });
    }
    function n() {
      ...
      if (
        ((a.content = i.textarea.val()), "" !== a.content.replace(/\s/g, ""))
      ) {
      ...
      a.focus(),
        document.selection
          ? ((e = document.selection.createRange()),
            ...
            (e.text = i))
          : ((e = [
              t.substring(0, a.selectionStart),
              i,
              t.substr(a.selectionEnd),
            ]),
            a.focus(),
            (a.value = e.join("")));
    }
    var o,
      ...
      _ =
            ...
            (a = m.extend(
              {
                ...
                defaultAvatar:
                  a.defaultAvatar ||
                  layui.cache.layimResPath + "images/default.png",
              },
              a
            )),
        ...
        (a.prototype.on = function (a, i) {
          return (
            "function" == typeof i && (b[a] ? b[a].push(i) : (b[a] = [i])), this
          );
        }),
        ...
        (a.prototype.chat = function (a) {
          if (window.JSON && window.JSON.parse) return A(a), this;
        }),
        ...
        (a.prototype.setChatStatus = function (a) {
          var i = z();
          if (i) return i.elem.find(".layim-chat-status").html(a), this;
        }),
        ...
        (a.prototype.setFriendStatus = function (a, i) {
          m(".layim-friend" + a)["online" === i ? "removeClass" : "addClass"](
            "layim-list-gray"
          );
        }),
      ...
      x = [
        ...
        '<img class="layim-{{= d.data.type }}{{= d.data.id }}" src="{{= d.data.avatar || layui.layim.cache().base.defaultAvatar }}"><span class="layim-chat-username" layim-event="{{= d.data.type==="group" ? "groupMembers" : "" }}">{{= d.data.name||"\u4f5a\u540d" }} {{=d.data.temporary ? "<cite>\u4e34\u65f6\u4f1a\u8bdd</cite>" : ""}} {{# if(d.data.type==="group"){ }} <em class="layim-chat-members"></em><i class="layui-icon">&#xe61a;</i> {{# } }}</span>',
        ...
        '<span class="layim-send-set" layim-event="setSend" lay-type="show"><i class="layui-icon layui-icon-down"></i></span>',
        '<ul class="layui-anim layim-menu-box">',
      ...
      $ = [
        ...
        '<div class="layim-add-img"><img class="layui-circle" src="{{= d.data.avatar || layui.layim.cache().base.defaultAvatar }}"><p>{{= d.data.name||"" }}</p></div>',
      ...
      w = [
        ...
        '<div class="layim-chat-user"><img src="{{= d.avatar || layui.layim.cache().base.defaultAvatar }}"><cite>',
        "{{# if(d.mine){ }}",
      ...
      k =
        '<li class="layim-{{= d.data.type }}{{= d.data.id }} layim-chatlist-{{= d.data.type }}{{= d.data.id }} layim-this" layim-event="tabChat"><img src="{{= d.data.avatar || layui.layim.cache().base.defaultAvatar }}"><span>{{= d.data.name||"\u4f5a\u540d" }}</span>{{# if(!d.base.brief){ }}<i class="layui-icon" layim-event="closeChat">&#x1007;</i>{{# } }}</li>',
      C =
        ...
        return f.open({
          ...
          success: function (a) {
            ...
            a.find("li").each(function () {
              ...
              0 < i.length && (i.reverse(), a.html(i.join(""))),
              F(),
              N.sign();
          },
          cancel: function (a) {
            ...
            return (
              (i.close = !0),
              layui.data("layim", { key: C.mine.id, value: i }),
              !1
            );
          },
        });
      ...
      S = function (a) {
        return (
          ...
          f.open({
            ...
            content:
              '<img src="' +
              (C.mine.avatar || C.base.defaultAvatar) +
              '"><span>' +
              (a || C.base.title || "\u6211\u7684 IM") +
              "</span>",
            ...
            success: function (a, i) {
              (e = a),
                ...
                a.on("click", function () {
                  ...
                  delete a.close,
                    layui.data("layim", { key: C.mine.id, value: a });
                });
            },
          })
        );
      ...
      A = function (t) {
        ...
        var a,
          i,
          e,
          n = m("#layui-layim-chat"),
          l = { data: t, base: C.base, local: C.local };
        if (!t.id) return f.msg("\u975e\u6cd5\u7528\u6237");
        if (n[0])
          return (
            (i = (a = r.find(".layim-chat-list")).find(
              ".layim-chatlist-" + t.type + t.id
            )),
            ...
            1 !== a.find("li").length ||
              i[0] ||
              (e || r.addClass("layui-layim-chat-more").css("width", 800),
              a.css({ height: r.height() }).show(),
              n.css("margin-left", "200px"),
              u && u.offset()),
            i[0] ||
              (a.append(p(k).render(l)), n.append(p(x).render(l)), G(t), H()),
        ...
        var s = (y = f.open({
          ...
          success: function (a, i, e) {
            (u = e),
              (r = a).css({ "min-width": "500px", "min-height": "450px" }),
              G(t),
          ...
          full: function (a) {
            f.style(s, { width: "100%", height: "100%" }, !0), H();
          },
          resizing: H,
          restore: H,
          min: function () {
      ...
      G = function (a) {
        m(".layim-" + a.type + a.id).each(function () {
          m(this).hasClass("layim-list-gray") &&
            layui.layim.setFriendStatus(a.id, "offline");
        });
      },
      H = function () {
        var a = r.find(".layim-chat-list"),
          ...
          e = r.height();
        a.css({ height: e }), i.css({ height: e - 52 - 158 });
      },
      L = function (e) {
        var a = e || z().data,
                ...
                t.minRight &&
                  f.style(i, {
                    left:
                      m(window).width() -
                      a.outerWidth() -
                      parseFloat(t.minRight),
                  }),
                a.find(".layui-layer-content span").on("click", function () {
                  f.close(i),
                    e
                      ? layui.each(C.chat, function (a, i) {
                          A(i);
                        })
                      : r.show(),
                    e && ((C.chat = []), E());
        ...
        return (
          ...
          (T.index = f.open({
            ...
            yes: function (a, i) {
              ...
              n
                ? t.submit && t.submit(e.val(), a)
                : t.submit && t.submit(e.val(), i.val(), a);
            },
          }))
        );
      },
      j = function (a, i) {
        var e =
            -1 === (a = a || m(".layim-chat-list ." + g)).index()
              ? 0
              : a.index(),
          t = ".layim-chat",
          n = r.find(t).eq(e),
        ...
        if (i)
          return (
            a.hasClass(g) && j(0 === e ? a.next() : a.prev()),
            1 === (i = r.find(t).length)
              ? f.close(y)
              : (a.remove(),
                n.remove(),
                2 === i &&
                  (r.find(".layim-chat-list").hide(),
                  l ||
                    r
                      .removeClass("layui-layim-chat-more")
                      .css("width", "600px"),
      ...
      K = function () {
        var a = z();
        C.message[a.data.type + a.data.id] &&
          delete C.message[a.data.type + a.data.id];
      },
      z = (a.prototype.thisChat = function () {
        var a, i;
        if (r)
          return (
            (a = m(".layim-chat-list ." + g).index()),
            (a = r.find(".layim-chat").eq(a)),
            (i = JSON.parse(
              decodeURIComponent(a.find(".layim-chat-tool").data("json"))
            )),
            { elem: a, data: i, textarea: a.find("textarea") }
          );
      }),
      P = function (a) {
      ...
      Y = function (a) {
        var i,
          ...
          l = n[a.type + a.id];
        o &&
          ((i = o.find(".layim-list-history")),
          (a.historyTime = new Date().getTime()),
          (n[a.type + a.id] = a),
          (e.history = n),
          layui.data("layim", { key: C.mine.id, value: e }),
          l ||
            ((t[a.type + a.id] = a),
            (n = p(s({ type: "history", item: "d.data" })).render({ data: t })),
            i.prepend(n),
      ...
      R = function (e) {
        var t,
          ...
          a,
          i,
          l = m(".layim-chatlist-" + (e = e || {}).type + e.id),
          s = {},
          o = l.index();
        if (
          ...
          C.base.voice &&
            (m("body").trigger("click"),
            R.init
              ? (h.ie && h.ie < 9) ||
                (((a = document.createElement("audio")).src =
                  layui.cache.layimResPath + "voice/" + C.base.voice),
                a.play())
              : (R.init = !0)),
          (!r && e.content) || -1 === o) &&
          (C.message[e.type + e.id]
            ? C.message[e.type + e.id].push(e)
            : ((C.message[e.type + e.id] = [e]),
              "friend" === e.type
                ? (layui.each(C.friend, function (a, i) {
                  ...
                  t ||
                    ((e.name = e.username), (e.temporary = !0), C.chat.push(e)))
                : "group" === e.type
                ? (layui.each(C.group, function (a, i) {
                    if (i.id == e.id)
                      return (
                        (i.type = "group"),
                        (i.name = i.groupname),
                  ...
                  n || ((e.name = e.groupname), C.chat.push(e)))
                : ((e.name = e.name || e.username || e.groupname),
                  C.chat.push(e))),
          "group" === e.type &&
            layui.each(C.group, function (a, i) {
              if (i.id == e.id)
                return (s.avatar = i.avatar || C.base.defaultAvatar), !0;
            }),
          !e.system)
        )
          return (
        ...
        r &&
          ((a = z()).data.type + a.data.id !== e.type + e.id &&
            (l.addClass("layui-anim layer-anim-06"),
            setTimeout(function () {
          ...
          e.system
            ...
            : "" !== e.content.replace(/\s/g, "") && i.append(p(w).render(e)),
          E());
      },
      B = "layui-anim-loop layer-anim-05",
      U = function (a) {
      ...
      X = function (e) {
        var t,
          ...
          i = ((a.chatlog = a.chatlog || {}), a.chatlog[e.type + e.id]);
        i
          ? (layui.each(i, function (a, i) {
      ...
      Z = function (e) {
        var t,
          ...
          i,
          n = {},
          l = o.find(".layim-list-" + e.type);
        if (C[e.type])
          if ("friend" === e.type)
            layui.each(C.friend, function (a, i) {
              if (e.groupid == i.id)
                return (
                  layui.each(C.friend[a].list, function (a, i) {
                    if (i.id == e.id) return (t = !0);
                  }),
                  t
                    ? f.msg(
                        "\u597d\u53cb [" +
            ...
            (n[C.group.length] = e), C.group.push(e);
          }
        t ||
          ((a = p(
            s({
      ...
      aa = function () {
        ...
        t.focus(),
          t.off("keydown").on("keydown", function (a) {
            var i = layui.data("layim")[C.mine.id] || {},
              e = a.keyCode;
            if ("Ctrl+Enter" === i.sendHotKey) a.ctrlKey && 13 === e && n();
            else if (13 === e) {
      ...
      N = {
        status: function (a, i) {
          ...
          "show" === t
            ? (I(i),
              ...
              m(document).off("click", e).on("click", e))
            : ((i = a.parent().prev()),
              a.addClass(g).siblings().removeClass(g),
              i.html(a.find("cite").html()),
              i
                .removeClass(
                  "layim-status-" + ("online" === t ? "hide" : "online")
                )
                .addClass("layim-status-" + t),
        ...
        tab: function (a) {
          var i,
            e = ".layim-tab-content",
            t = o.find(".layui-layim-tab>li");
          "number" == typeof a ? ((i = a), (a = t.eq(i))) : (i = a.index()),
            2 < i
              ? t.removeClass(g)
              : ((N.tab.index = i), a.addClass(g).siblings().removeClass(g)),
        ...
        spread: function (a) {
          ...
          a.next()["true" === i ? "removeClass" : "addClass"](v),
            ...
            layui.data("layim", { key: C.mine.id, value: t }),
            a.attr("lay-type", e),
        ...
        search: function (a) {
            ...
            if ("" === i) N.tab(0 | N.tab.index);
              ...
              for (
                ...
                for (var o = 0; o < (t[s].list || []).length; o++)
                  -1 !== t[s].list[o].username.indexOf(i) &&
                    ((t[s].list[o].type = "friend"),
                    (t[s].list[o].index = s),
                    (t[s].list[o].list = o),
                    e.push(t[s].list[o]));
              for (var d = 0; d < n.length; d++)
                -1 !== n[d].groupname.indexOf(i) &&
                  ((n[d].type = "group"),
                  (n[d].index = d),
                  (n[d].list = d),
                  e.push(n[d]));
              if (0 < e.length)
                for (var u = 0; u < e.length; u++)
                  l +=
                    ...
                    e[u].list +
                    '"><img src="' +
                    (e[u].avatar || C.base.defaultAvatar) +
                    '"><span>' +
                    (e[u].username || e[u].groupname || "\u4f5a\u540d") +
                    "</span><p>" +
                    (e[u].remark || e[u].sign || "") +
                    "</p></li>";
              else
          ...
          !C.base.isfriend && C.base.isgroup
            ? (N.tab.index = 1)
            : C.base.isfriend || C.base.isgroup || (N.tab.index = 2),
            e.show(),
            r.focus(),
            r.off("keyup", i).on("keyup", i);
        },
        closeSearch: function (a) {
          a.parent().hide(), N.tab(0 | N.tab.index);
        },
        msgbox: function () {
          var a = o.find(".layim-tool-msgbox");
          return (
            f.close(N.msgbox.index),
        ...
        skin: function () {
          f.open({
            ...
            zIndex: 66666666,
            resize: !1,
            content: p(q).render({ skin: C.base.skin }),
          });
        },
        about: function () {
          f.alert("\u7248\u672c\uff1a v" + t, {
        ...
        setSkin: function (a) {
          ...
          (a.skin = t) || delete a.skin,
            layui.data("layim", { key: C.mine.id, value: a });
          try {
            o.css({ "background-image": t ? "url(" + t + ")" : "none" }),
              r.css({ "background-image": t ? "url(" + t + ")" : "none" });
          } catch (a) {}
              ...
              (N.groupMembers.index = f.tips(
                ...
                d,
                {
                  ...
                  success: function (a) {
                    ...
                    s && t.css({ width: m(window).width() - 22 - (o || 200) }),
                      (i.data = m.extend(i.data, { id: e.data.id })),
                      c(i, function (e) {
        ...
        setSend: function (a, i) {
          ...
          "show" === t
            ? (I(i),
              e.show().addClass(M),
              m(document)
                .off("click", N.setSendHide)
                .on("click", N.setSendHide))
            : (a.addClass(g).siblings().removeClass(g),
        ...
        face: function (a, i) {
          var e,
            t = "",
            n = z();
          for (e in ia) t += '<li title="' + e + '">' + ia[e] + "</li>";
          (N.face.index = f.tips(
            (t = '<ul class="layui-clear layim-face-list">' + t + "</ul>"),
            a,
            {
              tips: 1,
              time: 0,
            ...
            m(document)
              .off("mousedown", N.faceHide)
              .on("mousedown", N.faceHide),
        ...
        image: function (a) {
          var i = a.data("type") || "images",
            e = z(),
            t = C.base[{ images: "uploadImage", file: "uploadFile" }[i]] || {};
          layui.upload.render({
            url: t.url || "",
            method: t.type,
            elem: a.find("input")[0],
          ...
          f.prompt(
            {
              ...
              shade: !1,
              offset: [
                a.offset().top - m(window).scrollTop() - 158 + "px",
                a.offset().left + "px",
              ],
            },
            function (a, i) {
              l(t.textarea[0], e + "[" + a + "]"), n(), f.close(i);
            }
          );
        },
        extend: function (e) {
        ...
        playAudio: function (a) {
          function i() {
            t.pause(), a.removeAttr("status"), a.find("i").html("&#xe652;");
          }
          var e = a.data("audio"),
          ...
          return C.base.chatLog
            ? (f.close(N.chatLog.index),
              (N.chatLog.index = f.open({
                ...
                content:
                  C.base.chatLog + "?id=" + i.data.id + "&type=" + i.data.type,
              })))
            : f.msg("\u672a\u5f00\u542f\u66f4\u591a\u804a\u5929\u8bb0\u5f55");
        },
        menuHistory: function (a, i) {
          var e,
            ...
            n = a.parent(),
            a = a.data("type"),
            l = o.find(".layim-list-history"),
            s =
              '<li class="layim-null">\u6682\u65e0\u5386\u53f2\u4f1a\u8bdd</li>';
          "one" === a
            ? (delete (e = t.history)[n.data("index")],
              (t.history = e),
              layui.data("layim", { key: C.mine.id, value: t }),
              m(".layim-list-history li.layim-" + n.data("index")).remove(),
              0 === l.find("li").length && l.html(s))
            : "all" === a &&
              (delete t.history,
              layui.data("layim", { key: C.mine.id, value: t }),
              l.html(s)),
